...
class ObjectiveProblemPreview extends Component {
    state = {
        op_description: '',
        op_total_score: '',
        op_tag: '',
        ...
        op_change: false,  // 是否对题目信息作出修改，如果没有则不可以提交修改
    }
            ...
            success: (resp) => {
                ...
                if (resp.error_message === "success") {
                    this.setState({
                        ...
                        op_author_id: resp.op_author_id,
                        op_author_name: resp.op_author_name,
                        op_use_count: resp.op_use_count,
                        op_difficulty: resp.op_difficulty,
                        op_change: false
                    });

                    // decide editable
                    if (parseInt(resp.op_author_id) === parseInt(this.props.user_id) || this.props.permission > 1) {
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                The deletion operation is irreversible. Do you confirm to delete the objective problem?
                            </div>
        ...
        if (this.state.show_preview) {
            ...
            return (
                <CodeMirror
                    ...
                    onChange={(op_description) => { this.setState({ op_description: op_description, op_change: true }) }}
                    basicSetup={{
                        tabSize: 4
                    }}
            ...
            return (
                <div className="container">
                    <ContendCard>
                        ...
                        <button className='btn btn-success float-end' onClick={() => this.handleSubmit()} disabled={this.state.is_loading || !this.state.op_change || this.state.disable_edit}>
                            {this.handleLoadingRender()}
                            Update
                        </button>
                        ...
                        <div className='row'>
                            <div className='col-md-4'>
                                <h4>View an Objective Problem</h4>
                            </div>
                        ...
                        <div className="row mb-2">
                            <div className="col-md-3">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <input type="text" className="form-control" id="op_author_name" defaultValue={this.state.op_author_name} disabled />
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-3">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <input type="text" className="form-control" id="op_tag" defaultValue={this.state.op_tag} onChange={(e) => { this.setState({ op_tag: e.target.value, op_change: true }); }} disabled={this.state.disable_edit} />
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-2">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <input type="number" className="form-control" id="op_total_score" defaultValue={this.state.op_total_score} onChange={(e) => { this.setState({ op_total_score: e.target.value, op_change: true }); }} min={1} disabled={this.state.disable_edit} />
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-2">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <input type="number" className="form-control" id="op_difficulty" defaultValue={this.state.op_difficulty} onChange={(e) => { this.setState({ op_difficulty: e.target.value, op_change: true }); }} min={1} max={5} disabled={this.state.disable_edit} />
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-2">
                        ...
                        <div className="row">
                            <div className="col">
                                <div className="row">
                                    ...
                                    <div className="col">
                                        <input type="text" className="form-control" id="op_correct_answer" defaultValue={this.state.op_correct_answer} onChange={(e) => { this.setState({ op_correct_answer: e.target.value, op_change: true }); }} disabled={this.state.disable_edit} />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <ContendCard>
                                <div className="row justify-content-md-center">
                                    <h1 className="text-center">
                                        View an Objective Problem ID={this.props.params.objective_problem_id}
                                    </h1>
                                    <hr />
