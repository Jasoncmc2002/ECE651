...
a.sort()
print("{:d}->{:d}->{:d}".format(a[0], a[1], a[2]), end=\'1\')
', 0, 0);
...
print(a.lower(), end=\'\') #输出kdjiskos234k,.;djfeij', 20, 4);
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (67, 5, 5, 6, 'def f(a, b):
    return a + b', 15, 3);
...
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (83, 3, 7, 12, 'def binary(x):
    ...
    while x > 0:
        ...
        x //= 2
    return count ', 20, 4);
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (84, 1, 9, 1, 'while True:
    a = 1', 0, 0);
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (85, 1, 9, 3, 'a, b = input().split()
a = int(a)
c = float(a) / 2 + 0.3
for i in range(0, int(round(c))):
    if i:
    ...
    for j in range(0, a):
        print(b, end = "")', 25, 2);
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (86, 1, 11, 1, 'a = list(map(int, input().split()))
a.sort()
print("{:d}->{:d}->{:d}".format(a[0], a[1], a[2]), end=\'\')', 20, 2);
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (87, 1, 11, 5, 'print(11, end=\'\')', 5, 1);
INSERT INTO yw.programming_answer (programming_answer_id, author_id, problem_set_id, programming_id, pa_code, pa_actual_score, pass_count) VALUES (90, 1, 10, 2, 'print(\'Hello World!\')', 0, 0);
